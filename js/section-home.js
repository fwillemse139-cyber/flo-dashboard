...
import * as notes from "./section-notes.js";
...
export function init(rootEl) {
  ...
  container.innerHTML =
    ...
    '<div class="home-grid">' +
      ...
      '<div class="home-card"><div class="home-card-title">Quick Notes</div><div id="home-w-notes"></div></div>' +
  ...
  notes.init(document.getElementById("home-w-notes"));
